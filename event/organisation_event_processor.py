...
class OrganisationEventProcessor(EventProcessor):
    ...
    def _handle_carrier_event(self, carrier: OrganisationEvent.Action.Carrier):
        ...
        lanes = ["S001.M003.02.01",  #Linie FB1 im Supermarkt nach dem Testen
                 "S001.M003.02.02",  #Linie FB2 im Supermarkt nach dem Testen
                 "S001.M005.01.03",  #Linie FK im Supermarkt nach dem Testen
                 "S001.M007.01.01",
                 "S001.M007.01.02",
                 "S001.M007.01.03", #Linie LD2 im Supermarkt des Central Warehouse
                 "S001.M004.01.02",
                 "S001.M007.01.04", #Linie LK2 im Supermarkt des Central Warehouse
                 "S001.M007.02.01", #Linie LG1 im Supermarkt des Central Warehouse
                 "S001.M007.02.02", #Linie LG2 im Supermarkt des Central Warehouse
                 "S001.M007.02.03", #Linie LG3 im Supermarkt des Central Warehouse
                 "S001.M007.02.04", #Linie LG4 im Supermarkt des Central Warehouse
                 "S001.M004.01.01", #Linie LD2 im Supermarkt Lieferant
                 "S001.M004.02.01",
                 "S001.M004.02.02",
                 "S001.M004.03.01",
                 "S001.M004.03.02",
                 "S001.M004.04.01",
                 "S001.M004.04.02",
                 "S001.M005.03.03"] #Linie FB2 im Supermarkt Fertigung
        pick_lanes = ["S001.M003.02.01",
                      "S001.M003.02.02",
                      "S001.M005.01.03",
                      "S001.M007.01.01", #Linie LD1 im Supermarkt des Central Warehouse
                      "S001.M007.01.02",
                      "S001.M007.01.03",
                      "S001.M004.01.02",
                      "S001.M007.01.04",
        ...
        lane_ids = ["aed94e2e-d66e-468a-bcf0-d122fdbc0b10",
                    ...
                    "417aec52-81db-459b-9259-21699851a9d1", #Linie LK2 im Supermarkt des Central Warehouse
                    "72638c2d-39fe-426f-aa6c-ba155236f1d0",
                    "266b32ef-d2e6-4b6a-979d-ab161cd5b83a", #Linie LG2 im Supermarkt des Central Warehouse
                    "04e45f88-44aa-41b1-b5d9-8183bf3fa935", #Linie LG3 im Supermarkt des Central Warehouse
                    "bd4e17b4-44a3-40f5-945a-ccf568820eae", #Linie LG4 im Supermarkt des Central Warehouse
        ...
        control_cycle_ids = ["51c97b7a-e490-4430-87e7-4d9a78046b44", #Kontrollzyklus FB1-SF im Supermarkt Fertigung
                             "15c5e6f6-a406-4f02-bac3-0521d51f86fc", #FB2-SF
                             "54c4b38d-174a-409f-9d86-5a98bcb464ee", #FB1-SM
                             "538a71e2-99b9-4e5d-8fab-bdcde4868f0d", #LD1-SL
                             "e1dc3046-93f5-48ed-b2cf-bd605e3eaff7", #LK1-SL
                             "50cb3ac3-e7b4-4db1-9690-9c89ff62ef97", #LD2-SL
                             "05925966-7932-4e7f-91ee-034b21e2ef5b", #LD1-SM
                             "5624ba3f-327e-4bd7-b021-81a9ac08f6cc",
                             "f1749739-f4ac-4206-af28-5bc7b3322484", #LG1-SL
                             "9adf1dbf-58ad-4ba1-bd29-22d25e22c53c", #LG2-SL
                             "a3ff8527-2582-474f-90b3-0abb7ae0c021", #LG3-SL
                             "082c2b14-e019-4fb0-9c88-200fa424aaa3", #LG4-SL
                             "f7362cb4-d4eb-4f83-a140-456141e96b10", #LD2-SM
                             "01ec2ee7-38db-4a9f-8e1c-5db90301b09e", #LK2-SM
                             "eee9e685-28b1-4f25-8cb9-67af433f7cc5", #LK1-SM
                             "1c83b022-c500-4b81-bef5-9b33b36127bb", #LG3-SM
                             "352f5c2e-2a62-43b6-b8a4-5344c9d30c32", #LG1-SM
                             "89e106ac-ce69-4d66-9e41-f81e2a014320", #LG4-SM
                             "420d411a-509a-490d-bc26-9cfd51330ea3", #LG2-SM
                             "41ffe350-3606-46e6-bc64-0655e6ae959a"] #FB2-SM
    ...
    def _get_linked_lane(source_address):
        # TODO improve me
        LINKED_KCC_SOURCE_LANE_ADDRESS = ["S001.M004.01.02", #Linie LD1 im Supermarkt Lieferant
                                          "S001.M006.02.04", #Linie FB1 im Supermarkt der Montage
                                          "S001.M006.02.05", #Linie LD1 im Supermarkt Montage
                                          "S001.M006.01.05", #Linie LD2 im Supermarkt Montage
                                          "S001.M006.01.04", #Linie FB2 im Supermarkt Montage
                                          "S001.M006.02.03", #Linie LG1 im Supermarkt Montage
                                          "S001.M006.01.03", #Linie LG3 im Supermarkt Montage
                                          "S001.M006.01.02", #Linie LG4 im Supermarkt Montage
                                          "S001.M006.02.02", #Linie LG2 im Supermarkt Montage
                                          "S001.M006.02.01", #Linie LK1 im Supermarkt Montage
                                          "S001.M006.01.01", #Linie LK2 im Supermarkt Montage
                                          "S001.M004.01.01",
                                          "S001.M004.02.01",
                                          "S001.M004.02.02", #Linie LK1 im Supermarkt Lieferant
                                          "S001.M004.03.01",  #Linie LG3 im Supermarkt Lieferant
                                          "S001.M004.03.02", #Linie LG1 im Supermarkt Lieferant
                                          "S001.M004.04.01", #Linie LG4 im Supermarkt Lieferant
                                          "S001.M004.04.02", #Linie LG2 im Supermarkt Lieferant
                                     "aadf95aa-c11e-41a5-adf3-377b540000ab",
                                     "8d20ae37-d762-4d4a-935a-2d07fec2af7e",
                                     "7a5dc1a2-d105-40ec-bcda-5f7c7cb2261b",
                                     "396e2360-6fec-4e18-9072-8b4e2c6c90fe",
