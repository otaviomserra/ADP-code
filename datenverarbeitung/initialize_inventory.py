...
Lager_Fertigung = {"S001.M003.02.01": 4, "S001.M003.02.02": 2, "S001.M003.02.03": 2}
SM_Lieferung = {"S001.M004.01.01": 3, "S001.M004.01.02": 4, "S001.M004.02.01": 4, "S001.M004.02.02": 3,
                "S001.M004.03.01": 3, "S001.M004.03.02": 5, "S001.M004.04.01": 4, "S001.M004.04.02": 3}
SM_Fertigung = {"S001.M005.01.01": 2, "S001.M005.01.02": 2, "S001.M005.01.03": 5,
                "S001.M005.02.01": 2, "S001.M005.02.02": 3,
                "S001.M005.03.01": 3, "S001.M005.03.02": 2, "S001.M005.03.03": 3,
                "S001.M005.04.01": 3, "S001.M005.04.02": 4}
...
Zentral_Lager = {"S001.M007.01.01": 3, "S001.M007.01.02": 2, "S001.M007.01.03": 3, "S001.M007.01.04": 5,
...
def generate_kafka_messages(lane, number_of_boxes, file):
    ...
    for prior_lane in box_paths[lane]:
        for i in range(number_of_boxes):
            ...
            file.write('[27/Oct/2023 0' + str(1 + box_paths[lane].index(prior_lane)) + f':00:0{i}] "DEBUG" ' +
        ...
        for i in range(number_of_boxes):
            ...
            file.write('[27/Oct/2023 0' + str(1 + box_paths[lane].index(prior_lane)) + f':30:0{i}] "DEBUG" ' +
                       '"ils_event_consumer" "KAFKA | RECEIVED | ' +
                       '[topic=organisation_events_1091c573-df2b-44e3-8755-64c8a09cebcc] | ' +
                       '[content={"header":{"traceId":"54b850b1-b646-4ef8-b8d6-817a3dc319bc",' +
                       '"id":"625505b6-24c8-4326-a96d-4ef5ffde3511",' +
    ...
    for i in range(number_of_boxes):
        file.write('[27/Oct/2023 0' + str(1 + path_size) + f':00:0{i}] "DEBUG" ' +
                   '"ils_event_consumer" "KAFKA | RECEIVED | ' +
                   '[topic=organisation_events_1091c573-df2b-44e3-8755-64c8a09cebcc] | ' +
                   '[content={"header":{"traceId":"54b850b1-b646-4ef8-b8d6-817a3dc319bc",' +
                   '"id":"625505b6-24c8-4326-a96d-4ef5ffde3511",' +
